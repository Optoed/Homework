		...
		if (stroka == a.size()-1) {
			...
			for (int l = 1; l <= stroka; l++) {
				...
				for (auto i : vecforsort) {
					//cout << "   element vecforsort'а = " << i << endl;
				}
...
void Print(vector<vector<int>> &a) {          //вывод содержимого массива
...
int main() { 
	...
	cout << "15. Диагонали, параллельные побочной по возрастанию с помощью сортировки вставками." << endl;
